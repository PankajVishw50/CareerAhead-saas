...
from counselling.views.decorators import counsellor_exists, slot_valid_exists, is_user_counsellor
    ...
    def patch(self, request, counsellor_id, slot_id):
        ...
        try:
            ...
            if not isinstance(operation, bool):
                return ErrorResponseTemplates.BAD_REQUEST("Invalid payload - `disable` should be an valid value")
        except KeyError:
            return ErrorResponseTemplates.BAD_REQUEST("Invalid payload - `disable` should be passed")
