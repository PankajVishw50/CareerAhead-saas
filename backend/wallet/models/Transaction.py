...
class TransactionManager(models.Manager):
    ...
    def create_transaction(self, sender, receiver, amount):
        ...
        transaction = self.model(
            sender=sender.wallet, receiver=receiver.wallet, amount=amount
        )
        transaction.save()
        return transaction
...
class Transaction(UUIDPrimaryFieldModel, TimeMonitorModel):
    ...
    sender = models.ForeignKey(
        Wallet, on_delete=models.CASCADE, related_name="sent_transaction"
    )

    receiver = models.ForeignKey(
        Wallet, on_delete=models.CASCADE, related_name="received_transaction"
    )
